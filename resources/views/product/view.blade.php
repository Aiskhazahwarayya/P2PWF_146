                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex items-center gap-2">
                            {{-- Policy: Hanya muncul jika user diizinkan meng-update produk ini --}}
                            @can('update', $product)
                                <a href="{{ route('product.edit', $product) }}"
                                    class="inline-flex items-center gap-1.5 px-3 py-2 text-sm font-medium rounded-lg border border-amber-300 dark:border-amber-600 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/30 transition">
                            ...
                            {{-- Policy: Hanya muncul jika user diizinkan men-delete produk ini --}}
                            @can('delete', $product)
                    ...
                    <div
                        ...
                        {{-- Quantity (Sudah diubah menjadi qty) --}}
                        <div class="flex items-center px-5 py-4">
